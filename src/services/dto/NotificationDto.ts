...
export default class NotificationDto {
     ...
     * 承認通知先Blockコード
     */
    private approvalNoticeBlockCode: number = null;

    /**
     * 承認通知先Url
     */
    private approvalNoticeUrl: string = null;
     ...
     * 承認通知先Blockコード取得
     */
    public getApprovalNoticeBlockCode (): number {
        return this.approvalNoticeBlockCode;
    }

    /**
     * 承認通知先Blockコード設定
     * @param approvalNoticeBlockCode
     */
    public setApprovalNoticeBlockCode (approvalNoticeBlockCode: number) {
        this.approvalNoticeBlockCode = approvalNoticeBlockCode;
    }

    /**
     * 承認通知先URL取得
     */
    public getApprovalNoticeUrl (): string {
        return this.approvalNoticeUrl;
    }

    /**
     * 承認通知先URL設定
     * @param approvalNoticeUrl
     */
    public setApprovalNoticeUrl (approvalNoticeUrl: string) {
        this.approvalNoticeUrl = approvalNoticeUrl;
    }
