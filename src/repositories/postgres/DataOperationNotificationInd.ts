 ...
 * データ操作定義テーブルエンティティ
 */
@Entity('data_operation_notification_ind')
export default class DataOperationNotificationInd {
    /**
     * ID
     */
    ...
    constructor (entity?: {}) {
        if (entity) {
            ...
            this.dataOperationNotificationId = parseInt(entity[entityName + 'data_operation_notification_id']);
