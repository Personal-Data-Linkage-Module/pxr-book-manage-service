...
export default class PostSearchUserRequestValidator implements ExpressMiddlewareInterface {
    async use (request: Request, response: Response, next: NextFunction) {
        ...
        const dto = await transformAndValidate(PostSearchUserReqDto, request.body);
