...
export default class PostCooperateUserRequestValidator implements ExpressMiddlewareInterface {
    async use (request: Request, response: Response, next: NextFunction): Promise<void> {
        ...
        const dto = await transformAndValidate(
            PostCooperateUserReqDto, request.body
        ) as PostCooperateUserReqDto;
        // 配列であればエラー
