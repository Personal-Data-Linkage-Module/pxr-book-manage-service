...
export default class ReleaseCooperateRequestValidator implements ExpressMiddlewareInterface {
    async use (request: Request, response: Response, next: NextFunction): Promise<void> {
        ...
        await transformAndValidate(ReleaseCooperateReqDto, request.body);
        next();
    }
}
