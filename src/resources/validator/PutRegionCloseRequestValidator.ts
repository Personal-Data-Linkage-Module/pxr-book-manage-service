...
export default class PutRegionCloseRequestValidator implements ExpressMiddlewareInterface {
    async use (request: Request, response: Response, next: NextFunction): Promise<void> {
        ...
        // パラメータバリデーション
        const dto = await transformAndValidate(PutRegionCloseReqDto, request.body);
