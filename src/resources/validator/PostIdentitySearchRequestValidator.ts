...
export default class PostIdentitySearchRequestValidator implements ExpressMiddlewareInterface {
    async use (request: Request, response: Response, next: NextFunction): Promise<void> {
        ...
        const dto = await transformAndValidate(PostIdentitySearchReqDto, request.body);
        // 配列であればエラー
