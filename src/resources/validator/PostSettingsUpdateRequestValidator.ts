...
export default class PostSettingsUpdateRequestValidator implements ExpressMiddlewareInterface {
    async use (req: express.Request, res: express.Response, next: express.NextFunction) {
        const dto = await transformAndValidate(PostSettingsUpdateReqDto, req.body);
