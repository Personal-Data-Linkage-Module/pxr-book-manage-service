...
export default class PostCreateMcdOutputCodeDataFileRequestValidator implements ExpressMiddlewareInterface {
    async use (request: Request, response: Response, next: NextFunction): Promise<void> {
        ...
        // リクエストバリデーション
        await transformAndValidate(PostCreateMcdOutputCodeDataFileReqDto, request.body);
        next();
    }
}
