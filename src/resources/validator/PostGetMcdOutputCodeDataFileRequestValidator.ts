...
export default class PostGetMcdOutputCodeDataFileRequestValidator implements ExpressMiddlewareInterface {
    async use (request: Request, response: Response, next: NextFunction): Promise<void> {
        ...
        // リクエストバリデーション
        await transformAndValidate(PostGetMcdOutputCodeDataFileReqDto, data);
        next();
    }
}
