...
export default class PostUpdateMcdOutputCodeDataFileRequestValidator implements ExpressMiddlewareInterface {
    async use (request: Request, response: Response, next: NextFunction): Promise<void> {
        ...
        // リクエストバリデーション
        await transformAndValidate(PostUpdateMcdOutputCodeDataFileReqDto, data);
        next();
    }
}
